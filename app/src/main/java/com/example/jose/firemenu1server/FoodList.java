package com.example.jose.firemenu1server;
...
import com.example.jose.firemenu1server.Model.Category;
import com.example.jose.firemenu1server.Model.Food;
import com.example.jose.firemenu1server.ViewHolder.FoodViewHolder;
...
public class FoodList extends AppCompatActivity {
    ...
    private void showAddFoodDialog() {
        ...
        edtDescription = add_new_layout.findViewById(R.id.edtDescription);
        edtPrice = add_new_layout.findViewById(R.id.edtPrice);
        edtDiscount = add_new_layout.findViewById(R.id.edtDiscount);
